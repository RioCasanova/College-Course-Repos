...
namespace HogWildSystem.BLL
{
    public class CustomerService
    {
        ...
        public CustomerEditView GetCustomer(int customerID)
        {
            ...
            .Where(x => (x.CustomerID == customerID && x.RemoveFromViewFlag == false))
        ...
        //  Customer Savepublic CustomerEditView

        private CustomerEditView Save(CustomerEditView editCustomer)
        {
            ...
            #endregion Business Logic and Parameter Exceptions
