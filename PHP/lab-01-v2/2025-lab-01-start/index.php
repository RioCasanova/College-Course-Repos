    ...
    <main>
                    ...
                    <div class="row g-3 p-3 bg-primary-subtle rounded">
                        ...
                        <div class="col-12">
                            ...
                            <input type="number" class="form-control" id="number_of_assignments"
                                name="number_of_assignments" value="<?php echo $number_of_assignments; ?>"
                                placeholder="0">
                        </div>
        ...
        if (isset($_POST['number_of_assignments'])) {
            ...
            if ($number_of_assignments <= 0) {
                echo "<p>Invalid number of assignments. Please enter a positive number.</p>";
            } else {
            ...
            for ($i = 1; $i <= $number_of_assignments; $i++) {
                ...
                echo "<input type='number' class='form-control' id='assignment$i' name='assignment$i' required>";
                echo "</div>";
                echo "<div class='col-6'>";
                echo "<label for='weight$i' class='form-label'>Weight:</label>";
                echo "<input type='number' class='form-control' id='weight$i' name='weight$i' value='<?php echo $i?>' placeholder='' required>";
                echo "</div>";
            }
            ...
            if (isset($_POST['submitTwo'])) {
                ...
                if (0 < intval($_POST['desired_grade'])) {
                    ...
                    $formatted_weighted_mark = number_format($weighted_mark, 2);
                    $formatted_required_grade = number_format($required_grade, 2);
                    echo $formatted_weighted_mark;
                    echo $formatted_required_grade;
                } else {
                    $formatted_weighted_mark = number_format($weighted_mark, 2);
                    echo $formatted_weighted_mark;
                }
