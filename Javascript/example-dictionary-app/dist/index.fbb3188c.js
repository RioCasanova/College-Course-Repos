...
var _dictionary = require("../js/api/dictionary");
var _wordItem = require("../js/dom/word-item");
(function() {
    ...
    dictionaryForm.addEventListener("submit", (evt)=>{
        ...
        const wordData = (0, _dictionary.getWord)(searchValue);
        wordData.then((data)=>{
            (0, _wordItem.createWordItem)(data[0]);
        });
    });
...
},{"bootstrap/dist/css/bootstrap.min.css":"i5LP7","../js/api/dictionary":"bzxk5","../js/dom/word-item":"knX6L","bootstrap":"h36JB"}],"i5LP7":[function() {},{}],"bzxk5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getWord", ()=>getWord);
async function getWord(searchValue) {
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3Unyy","bDbGG"], "bDbGG", "parcelRequire94c2")
